      ...
      builder: (context, snapshot) {
        switch (snapshot.connectionState) {
          case ConnectionState.done:
            if ((user != null) && (snapshot.data!.exists)) {
              return Setup(user: snapshot.data);
            } else {
              return Setup();
...
class Setup extends StatefulWidget {
  ...
  const Setup({Key? key, this.user}) : super(key: key);

  @override
  _SetupState createState() => _SetupState(user);
}
...
class _SetupState extends State<Setup> {
  ...
  _SetupState(user) {
    ...
    if (userExists) setUserValues(user);
  }
              ...
              content: Column(
                ...
                children: <Widget>[
                  ...
                  TextField(
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: _major == '' ? 'I\'m studying...' : _major,
                      ),
                      onChanged: (text) {
                        _major = text;
                      }),
                  ...
                  TextField(
                      ...
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: _blurb == '' ? 'Profile Blurb' : _blurb,
                      ),
                      onChanged: (text) {
                        _blurb = text;
                      }),
